        ...
        <div class="row">
            ...
            <div class="col-md-8" id="col-left">
                <div class="row" id="row-data">
                    <?php $no = 1;
                    foreach ($barangs_sayur->result() as $barang) : ?>
                                    ...
                                    <div class="row">
                                        <div class="col-6 border-right">
                                            ...
                                            <div style="margin-top:22px;">
                                                <select name="input_qty" id="select_qty_<?= $barang->barang_id ?>" data-barang_id="<?= $barang->barang_id; ?>" style="width:45px;<?= ($barang->satuan_nama == 'Kg') ? 'display:inline;' : 'display:none;'; ?>">
                                                ...
                                                <input type="number" onkeyup="qtyInput(event);" onchange="qtyInput2(event);" data-no="<?= $no; ?>" data-barang_id="<?= $barang->barang_id; ?>" id="<?= 'qty_input_' . $barang->barang_id; ?>" placeholder="0" min="1" style="width:45px;<?= ($barang->satuan_nama == 'Kg') ? 'display:none;' : 'display:inline;'; ?>"> <?= $barang->satuan_nama; ?>
                                            </div>
                                        </div>
                                        <div class="col-6">
            ...
            <div class="col-md-4" id="parent-cart">
                <div class="overlay-wrapper">
                    ...
                    <div id="cart-right">
                        ...
                        <button class="btn btn-primary btn-block" id="btn-cekout" <?php if ($keranjang->num_rows() == 0) {
                                                                                        echo "disabled";
                                                                                    } ?>>Checkout</button>
                    </div>
                </div>
