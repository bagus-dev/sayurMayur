        ...
        <div class="row">
            ...
            <div class="col-md-8" id="col-left">
                <div class="row" id="row-data">
                    <?php $no = 1;
                    foreach ($barangs_bumbu->result() as $barang) : ?>
                                    ...
                                    <div class="row">
                                        <div class="col-6 border-right">
                                            ...
                                            <div style="margin-top:22px;">
                                                ...
                                                <input type="number" onkeyup="qtyInput(event);" onchange="qtyInput2(event);" data-no="<?= $no; ?>" data-barang_id="<?= $barang->barang_id; ?>" id="<?= 'qty_input_' . $barang->barang_id; ?>" placeholder="0" min="0" style="width:45px;<?= ($barang->satuan_nama == 'Kg') ? 'display:none;' : 'display:inline;'; ?>"> <?= $barang->satuan_nama; ?>
                                            </div>
                                        </div>
                                        <div class="col-6">
