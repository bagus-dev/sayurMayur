                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="barang_cart_right">
                            ...
                            <tr class="text-left" id="<?= 'cart_row_'.$k->id; ?>">
                                ...
                                <td><input type="number" class="qty_input" onkeyup="changeQtyCart(event);" onchange="changeQtyCart2(event);" id="<?= 'input_kuantitas_cart_'.$k->id; ?>" data-cart_id="<?= $k->id; ?>" style="width:50px" value="<?= $k->total_kuantitas; ?>"></td>
