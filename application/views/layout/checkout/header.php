...
<body style="background-image: url('<?= base_url(); ?>assets/pos/img/background.png');">
    <nav class="navbar navbar-expand-lg navbar fixed-top navbar-light bg-light shadows">
        <div class="container">
            ...
            <a class="navbar-brand" href="<?= site_url(); ?>"><b>Radja</b>Sayur</a>
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link <?php if (isset($keranjangs)) {
                                            echo 'active';
                                        } ?>" href="<?= base_url() . 'page/cart'; ?>"><i class="fa fa-shopping-cart btn-sm"></i> Keranjang <span class="badge bg-dark" id="badge_cart"><?php if (isset($keranjang)) {
                                                                                                                                                                                                                                    echo $keranjang->num_rows();
                                                                                                                                                                                                                                } elseif (isset($keranjangs)) {
                                                                                                                                                                                                                                    echo $keranjangs->num_rows();
                                                                                                                                                                                                                                } ?></span></a>
                </li>
            </ul>
            <?php
