    ...
    <div class="card">
        <div class="card-body">
            ...
            ?>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <h1 class="text-dark" id="text1">Radja<small class="text-danger">Sayur</small></h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <br>
                            <span class="float-right">RadjaSayur</span>
                            <br>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php
                                                if ($c->kuantitas >= 1) {
                                                    echo $c->kuantitas . " " . $c->satuan_nama;
                                                } else if ($c->kuantitas == 0.25) {
                                                    echo "1/4" . " " . $c->satuan_nama;
                                                } else if ($c->kuantitas == 0.5) {
                                                    echo "1/2" . " " . $c->satuan_nama;
                                                } else if ($c->kuantitas == 0.75) {
                                                    echo "3/4" . " " . $c->satuan_nama;
                                                }
                                                ?>
                                            </td>
                    ...
                    ?>
                            ...
                            <div class="row">
                                <?php if ($i->jenis_bayar == 1) { ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="dibayar" id="dibayar" class="form-control" placeholder="Total Dibayar">
                                        </div>
                                        <div class="form-group">
                                ...
                                <?php }
                            } elseif ($i->jenis_bayar == 2 and $i->status == 0) { ?>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Status Pesanan</label>
                                        <select name="status" id="status" class="custom-select">
